...
CREATE TABLE IF NOT EXISTS `permission` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='权限表' AUTO_INCREMENT=10 ;

--
-- 插入之前先把表清空（truncate） `permission`
--
...
INSERT INTO `permission` (`id`, `name`, `sign`, `description`) VALUES
(1, '新增用户', 'user:create', NULL),
(2, '更新用户', 'user:update', NULL),
(3, '删除用户', 'user:delete', NULL),
(4, '读取用户', 'user:read', NULL),
(5, '新增房屋', 'house:create', NULL),
(6, '房屋更新', 'house:update', NULL),
(7, '房屋审核', 'house:check', NULL),
(8, '读取房屋', 'house:read', NULL),
(9, '删除房屋', 'house:delete', NULL);
...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `description` varchar(256) DEFAULT NULL COMMENT '角色描述，用于ui界面的使用',
  PRIMARY KEY (`id`)
...
INSERT INTO `role` (`id`, `name`, `sign`, `description`) VALUES
(1, '访客', 'GUEST', NULL),
(2, '顾客', 'CUSTOMER', NULL),
(3, '业主', 'OWNER', NULL),
(4, '管理员', 'ADMIN', NULL);
...
CREATE TABLE IF NOT EXISTS `rolePermission` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='角色权限表' AUTO_INCREMENT=26 ;

--
-- 插入之前先把表清空（truncate） `rolePermission`
--

TRUNCATE TABLE `rolePermission`;
--
-- 转存表中的数据 `rolePermission`
--
...
CREATE TABLE IF NOT EXISTS `userRole` (
  ...
  `roleId` int(10) NOT NULL COMMENT '角色表主键',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户角色表' AUTO_INCREMENT=6 ;

--
-- 插入之前先把表清空（truncate） `userRole`
--
