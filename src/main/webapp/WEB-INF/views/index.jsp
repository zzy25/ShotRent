...
<head>
    ...
    <link href="<%=basePath%>assets/media/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>

    <link href="<%=basePath%>assets/media/css/daterangepicker.css" rel="stylesheet" type="text/css" />

    <link href="<%=basePath%>assets/media/css/fullcalendar.css" rel="stylesheet" type="text/css"/>

    <link href="<%=basePath%>assets/media/css/jqvmap.css" rel="stylesheet" type="text/css" media="screen"/>

    <link href="<%=basePath%>assets/media/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
                        ...
                        <div class="portlet solid bordered light-grey">
                            ...
                            <div class="portlet-body">
                                ...
                                <div id="site_statistics_loading">
                                    ...
                                    <img src="<%=basePath%>assets/media/image/loading.gif" alt="loading" />
                                            ...
                                            <div class="scroller" data-height="290px" data-always-visible="1" data-rail-visible1="1">
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span6 user-info">
                                                        ...
                                                        <img alt="" src="<%=basePath%>assets/media/image/avatar.png" />
                                ...
                                <div class="scroller" data-height="435px" data-always-visible="1" data-rail-visible1="1">
                                    ...
                                    <ul class="chats">
                                        ...
                                        <li class="in">
                                            ...
                                            <img class="avatar" alt="" src="<%=basePath%>assets/media/image/avatar1.jpg" />
                                        ...
                                        <li class="out">
                                            ...
                                            <img class="avatar" alt="" src="<%=basePath%>assets/media/image/avatar2.jpg" />
                                        ...
                                        <li class="out">
                                            ...
                                            <img class="avatar" alt="" src="<%=basePath%>assets/media/image/avatar3.jpg" />
...
<script src="<%=basePath%>assets/media/js/jquery.vmap.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.vmap.russia.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.vmap.world.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.vmap.europe.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.vmap.germany.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.vmap.usa.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.vmap.sampledata.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.flot.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.flot.resize.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.pulsate.min.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/date.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/daterangepicker.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.gritter.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/fullcalendar.min.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.easy-pie-chart.js" type="text/javascript"></script>

<script src="<%=basePath%>assets/media/js/jquery.sparkline.min.js" type="text/javascript"></script>
...
<script src="<%=basePath%>assets/media/js/index.js" type="text/javascript"></script>
